dir = '/lab/yaoshaowei/pycharm/opennmt-amr/data/nmt/'
...
def dep_to_levi(dirt, name, Sequential=False):
	...
	if name == "train":
		file_1 = dir+dirt+"news-commentary-v11.cs-en.clean.tok.en"
		file_2 = dir+dirt+"news-commentary-v11.cs-en.clean.deprels.en"
		file_3 = dir+dirt+"news-commentary-v11.cs-en.clean.heads.en"
	elif name == "test":
		file_1 = dir+"test/newstest2016-encs-src.tok.en"
		file_2 = dir+"test/newstest2016-encs-src.deprels.en"
		file_3 = dir+"test/newstest2016-encs-src.heads.en"
	elif name == "val":
		file_1 = dir+"dev/newstest2015-encs-src.tok.en"
		file_2 = dir+"dev/newstest2015-encs-src.deprels.en"
		file_3 = dir+"dev/newstest2015-encs-src.heads.en"

	print(file_1)
	file_4 = dir + dirt + name + ".en.tok"
	file_5 = dir + dirt + name + ".en.deps"
	f1 = open(file_1, "r")
	f2 = open(file_2, "r")
	f3 = open(file_3, "r")
	h1 = open(file_4, "w")
